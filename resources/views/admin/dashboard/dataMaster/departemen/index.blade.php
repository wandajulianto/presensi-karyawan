            ...
            <div class="card-body">
              <div class="table-responsive">
                <div class="d-flex mb-3">
                  <a href="{{ route('data-master.departemen.create') }}" class="btn btn-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-plus"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 5l0 14" /><path d="M5 12l14 0" /></svg>
                    Tambah Data Departemen
                  </a>
                </div>
                <form action="{{ route('data-master.departemen') }}" method="GET">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <input type="text" class="form-control" name="nama_departemen" value="{{ request('nama_departemen') }}" placeholder="Cari Nama Departemen">
                      </div>
                    </div>
                  ...
                  <tbody>
                    @foreach ($departemens as $departemen)
                      <tr>
                        ...
                        <td>
                          <a href="{{ route('data-master.departemen.edit', $departemen->kode_departemen) }}" class="btn btn-warning">
                            <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-edit"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M7 7h-1a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-1" /><path d="M20.385 6.585a2.1 2.1 0 0 0 -2.97 -2.97l-8.415 8.385v3h3l8.385 -8.415z" /><path d="M16 5l3 3" /></svg>
                            Edit
                          </a>
                          <button type="button" class="btn btn-danger btn-delete text-2xl" data-kode="{{ $departemen->kode_departemen }}" data-nama="{{ $departemen->nama_departemen }}">
                ...
                <div class="d-flex justify-content-center mt-3">
                  {{ $departemens->appends(request()->query())->links('vendor.pagination.bootstrap-5') }}
                </div>
              </div>
            </div>
          </div>
      ...
      button.addEventListener('click', function() {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            form.method = 'POST';
            form.action = `/admin/data-master/departemen/${kode}`;
