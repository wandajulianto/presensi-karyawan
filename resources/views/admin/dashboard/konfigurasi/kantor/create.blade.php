    ...
    <div class="container-xl">
      <div class="row g-2 align-items-center">
        <div class="col">
          ...
          <h2 class="page-title">Tambah Kantor Baru</h2>
        </div>
            ...
            <div class="form-section">
                ...
                <div class="col-md-8">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('nama_kantor') is-invalid @enderror" 
                           name="nama_kantor" value="{{ old('nama_kantor') }}" 
                ...
                <div class="col-md-4">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('kode_kantor') is-invalid @enderror" 
                           name="kode_kantor" value="{{ old('kode_kantor') }}" 
              ...
              <div class="mb-3">
                ...
                <textarea class="form-control @error('alamat') is-invalid @enderror" 
                          name="alamat" rows="3" placeholder="Masukkan alamat lengkap kantor">{{ old('alamat') }}</textarea>
                @error('alamat')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
              ...
              <div class="mb-3">
                ...
                <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                          name="deskripsi" rows="2" placeholder="Deskripsi tambahan (opsional)">{{ old('deskripsi') }}</textarea>
                @error('deskripsi')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
              ...
              <div class="map-instructions">
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    ...
                    <div class="small">Klik pada peta di bawah untuk menentukan koordinat kantor. Koordinat akan terisi otomatis.</div>
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <input type="number" step="any" class="form-control coordinate-input @error('latitude') is-invalid @enderror" 
                           name="latitude" id="latitude" value="{{ old('latitude', -7.333174936756437) }}" 
                ...
                <div class="col-md-6">
                  <div class="mb-3">
                    ...
                    <input type="number" step="any" class="form-control coordinate-input @error('longitude') is-invalid @enderror" 
                           name="longitude" id="longitude" value="{{ old('longitude', 108.2197967875599) }}" 
              ...
              <div class="mb-3">
                ...
                <div class="input-group">
                  <input type="number" class="form-control @error('radius_meter') is-invalid @enderror" 
                         name="radius_meter" id="radius_meter" value="{{ old('radius_meter', 20) }}" 
                ...
                <div class="col-md-4">
                  <div class="mb-3">
                    ...
                    <input type="time" class="form-control @error('jam_masuk') is-invalid @enderror" 
                           name="jam_masuk" value="{{ old('jam_masuk', '07:00') }}">
                    @error('jam_masuk')
                      <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                  </div>
                ...
                <div class="col-md-4">
                  <div class="mb-3">
                    ...
                    <input type="time" class="form-control @error('jam_keluar') is-invalid @enderror" 
                           name="jam_keluar" value="{{ old('jam_keluar', '17:00') }}">
                    @error('jam_keluar')
                      <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                  </div>
...
<script>
  ...
  // Initialize map
  function initMap() {
    const defaultLat = {{ old('latitude', -7.333174936756437) }};
    const defaultLng = {{ old('longitude', 108.2197967875599) }};
    const defaultRadius = {{ old('radius_meter', 20) }};
